...
#ifndef INCLUDE_POISSON_CUDA_MULTIGRID_PRECONDITIONER_H_
#define INCLUDE_POISSON_CUDA_MULTIGRID_PRECONDITIONER_H_

#include <exadg/operators/cuda_multigrid_operator.h>
...
private:
  ...
  typedef ExaDG::Poisson::CUDAWrappers::LaplaceOperator<dim, MultigridNumber, n_components> Laplace;
...
public:
  ...
  initialize(MultigridData const &                                                mg_data,
             ...
             ExaDG::Poisson::CUDAWrappers::LaplaceOperatorData<rank, dim> const & data_in,
...
private:
  ...
  ExaDG::Poisson::CUDAWrappers::LaplaceOperatorData<rank, dim> data;
...
#endif /* INCLUDE_POISSON_CUDA_MULTIGRID_PRECONDITIONER_H_ */
