...
#ifndef INCLUDE_LAPLACE_DG_LAPLACE_OPERATION_DEVICE_H_
#define INCLUDE_LAPLACE_DG_LAPLACE_OPERATION_DEVICE_H_
...
#include <exadg/poisson/spatial_discretization/cuda_laplace_operator.h>
#include <exadg/poisson/spatial_discretization/cuda_rhs_operator.h>
// TODO:cuda operators
...
private:
  ...
  typedef ExaDG::Poisson::CUDAWrappers::LaplaceOperator<dim, Number, n_components> Laplace;

  typedef dealii::LinearAlgebra::distributed::Vector<Number, dealii::MemorySpace::CUDA> VectorType;
  typedef dealii::LinearAlgebra::distributed::Vector<double, dealii::MemorySpace::CUDA>
    VectorTypeDouble;
...
public:
  ...
  void
  setup(std::shared_ptr<ExaDG::CUDAWrappers::MatrixFree<dim, Number>> matrix_free,
...
private:
  ...
  std::string const dof_index                = "cuda_laplace";
  std::string const quad_index               = "cuda_laplace";
  std::string const quad_index_gauss_lobatto = "cuda_laplace_gauss_lobatto";

  std::shared_ptr<ExaDG::CUDAWrappers::MatrixFree<dim, Number>> matrix_free;
  std::shared_ptr<MatrixFreeData<dim, Number>>                  matrix_free_data;
  ...
  ExaDG::CUDAWrappers::RHSOperator<dim, Number, n_components> rhs_operator;

  Laplace laplace_operator;

  // TODO:
  std::shared_ptr<ExaDG::CUDAWrappers::PreconditionerBase<Number>> preconditioner;
