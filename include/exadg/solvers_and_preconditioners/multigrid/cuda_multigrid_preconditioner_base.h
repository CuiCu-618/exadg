...
#ifndef INCLUDE_SOLVERS_AND_PRECONDITIONERS_CUDA_MULTIGRID_PRECONDITIONER_ADAPTER_BASE_H_
#define INCLUDE_SOLVERS_AND_PRECONDITIONERS_CUDA_MULTIGRID_PRECONDITIONER_ADAPTER_BASE_H_
...
// class ExaDG::CUDAWrappers::MultigridAlgorithm;
...
protected:
  ...
  typedef dealii::LinearAlgebra::distributed::Vector<MultigridNumber, dealii::MemorySpace::CUDA>
    VectorTypeMG;
...
protected:
  ...
  dealii::MGLevelObject<std::shared_ptr<ExaDG::CUDAWrappers::MatrixFree<dim, MultigridNumber>>>
                                                   matrix_free_objects;
...
#endif /* INCLUDE_SOLVERS_AND_PRECONDITIONERS_CUDA_MULTIGRID_PRECONDITIONER_ADAPTER_BASE_H_ \
        */
