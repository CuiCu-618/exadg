...
plain_copy(VectorType & dst, const VectorType2 & src)
{
  ...
  vec_equ<typename VectorType::value_type, typename VectorType2::value_type>
...
public:
  ...
  solve(OtherVectorType & dst, OtherVectorType const & src) const
  {
    ...
    plain_copy(solution[maxlevel], dst);
